...
namespace JobPortal.Migrations
{
    ...
    [Migration("20251011062402_AddPreferredContactDateToContactMessage")]
    partial class AddPreferredContactDateToContactMessage
    {
            ...
            modelBuilder.Entity("JobPortal.Models.JobAlertSubscription", b =>
                {
                    ...
                    b.HasIndex("UserId", "Keyword", "Country", "JobType")
                        .IsUnique()
                        .HasFilter("[Keyword] IS NOT NULL AND [Country] IS NOT NULL AND [JobType] IS NOT NULL");
