        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Qualifications = table.Column<string>(maxLength: 200, nullable: true),
                    Experience = table.Column<string>(maxLength: 200, nullable: true),
                    Skills = table.Column<string>(maxLength: 200, nullable: true),
                    CompanyName = table.Column<string>(maxLength: 120, nullable: true),
                    CompanyWebsite = table.Column<string>(maxLength: 200, nullable: true),
                    CompanyLogoPath = table.Column<string>(maxLength: 200, nullable: true),
                    Location = table.Column<string>(maxLength: 120, nullable: true),
                    Country = table.Column<string>(maxLength: 80, nullable: true),
                    JobType = table.Column<string>(maxLength: 50, nullable: true),
                    Salary = table.Column<string>(maxLength: 80, nullable: true),
